...
#%% To start
import os
os.chdir('C:/Users/wills/Desktop/Heat Pump Paper/Data/social cost')
import pandas as pd
import numpy as np

#%%
location='C:/Users/wills/Desktop/Heat Pump Paper/Data/National/'
National_df=pd.read_stata(location+'treatment and mixed control group-same county-drop remodel after 2000-only 2 periods-drop EL-Remodel_AGE.dta')
...
National_df.to_stata('treatment and mixed control group-same county-drop remodel after 2000-only 2 periods-drop EL-Remodel_AGE-with cost.dta')